import 'dart:io'; // Penting untuk menangani file
...
class _IzinFormScreenState extends State<IzinFormPage> {
  ...
  final ImagePicker _picker = ImagePicker(); // Instance untuk ambil foto
  ...
  Future<void> _pickImage() async {
    final XFile? image = await _picker.pickImage(
      ...
      imageQuality: 50, // Kompres kualitas agar tidak terlalu berat di server
    );
    if (image != null) {
  ...
  void _loadData() async {
    ...
    if (mounted) setState(() => _namaKelas = prefs.getString('nama_kelas') ?? "-");
  ...
  void _handleSubmit() async {
    ...
    if (_selectedSiswaId == null || _selectedStatus == null) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Lengkapi form wajib")));
      return;
    }
    ...
    try {
      await _izinService.kirimIzin(
        ...
        foto: _selectedImage, // Kirim foto ke service
      );
  ...
  void _resetForm() {
    setState(() {
      ...
      _jamKeMulai = null;
      _jamKeSelesai = null;
      _selectedImage = null; // Reset foto
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // --- WIDGET FOTO BARU ---
                    _buildLabel("Bukti Foto (Opsional)", false),
                    _buildImagePicker(),
        ...
        child: _selectedImage == null
            ? Column(
                children: [
                  ...
                  Text("Pilih Foto Bukti", style: GoogleFonts.poppins(fontSize: 12, color: Colors.grey[600])),
                ],
              )
            : Column(
                children: [
                  ...
                  TextButton.icon(
                    ...
                    label: Text("Hapus Foto", style: GoogleFonts.poppins(color: Colors.red, fontSize: 12)),
                  ),
                ],
              ),
      ),
  ...
  // --- Widget helper tetap sama dengan kode awalmu ---
  ...
  // (Fungsi _buildSiswaDropdown, _buildStatusDropdown, dll tetap dipertahankan dari kode aslimu)
  // ... (Kodingan Dropdown & Inputmu yang lain tetap sama) ...
        ...
        showModalBottomSheet(
          ...
          builder: (context) => Container(
            ...
            child: Column(
              ...
              children: [
                Text("Pilih Siswa Binaan", style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 16)),
                const Divider(),
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, i) => ListTile(
                      ...
                      title: Text(_listSiswa[i].nama, style: GoogleFonts.poppins(fontSize: 14)),
                      onTap: () {
                        setState(() {
      ...
      child: _buildContainerInput(
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              Text(_selectedSiswaNama ?? "Pilih Siswa...", style: GoogleFonts.poppins(fontSize: 14, color: _selectedSiswaNama == null ? Colors.grey : Colors.black87)),
        ...
        showModalBottomSheet(
          ...
          builder: (context) => Column(
            ...
            children: [
              ...
              Text("Jenis Halangan", style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 16)),
              const Divider(),
              ..._opsiStatus.map((s) => ListTile(
                    leading: Icon(s == 'Sakit' ? Icons.medical_services_outlined : Icons.info_outline, color: const Color(0xFF2563EB)),
      ...
      child: _buildContainerInput(
        child: Padding(
          ...
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Text(_selectedStatus ?? "Pilih Alasan...", style: GoogleFonts.poppins(fontSize: 14, color: _selectedStatus == null ? Colors.grey : Colors.black87)),
              const Icon(Icons.arrow_drop_down, color: Colors.grey),
            ],
          ),
        ),
    ...
    return InkWell(
      ...
      child: _buildContainerInput(
        child: Row(
          ...
          children: [
            Text(
              _selectedDateRange == null ? "Pilih Rentang Tanggal" : "${_formatDateDisplay(_selectedDateRange!.start)} - ${_formatDateDisplay(_selectedDateRange!.end)}",
                  ...
                  _buildContainerInput(
                    child: DropdownButtonHideUnderline(
                      child: DropdownButtonFormField<int>(
                        ...
                        items: _listJamKe.map((e) => DropdownMenuItem(value: e, child: Text("Jam-$e"))).toList(),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(child: Text("Kelas Binaan: $_namaKelas", style: GoogleFonts.poppins(fontWeight: FontWeight.bold, color: Colors.blue[800], fontSize: 12))),
        ],
      ),
    );
  }
  ...
  Widget _buildFullDayToggle() {
    return Row(
      ...
      children: [
        ...
        Switch(value: _isFullDay, activeTrackColor: const Color(0xFF2563EB), onChanged: (v) => setState(() => _isFullDay = v)),
      ],
    );
  }
  ...
  Widget _buildKeteranganField() {
    return _buildContainerInput(
      child: TextFormField(
        ...
        maxLines: 3,
        decoration: InputDecoration(hintText: "Contoh: Demam tinggi sejak semalam...", hintStyle: GoogleFonts.poppins(fontSize: 13, color: Colors.grey[400]), border: InputBorder.none),
    ...
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: _isSubmitting ? Colors.orange[300] : Colors.orange[600],
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
          elevation: 4,
        ),
        icon: _isSubmitting ? const SizedBox(width: 20, height: 20, child: CircularProgressIndicator(color: Colors.white, strokeWidth: 2)) : const Icon(Icons.send_rounded, color: Colors.white),
        label: Text(_isSubmitting ? "MENGIRIM..." : "KIRIM PENGAJUAN", style: GoogleFonts.poppins(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14)),
      ),
    );
  }
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(padding: const EdgeInsets.all(16), decoration: BoxDecoration(color: Colors.green[50], shape: BoxShape.circle), child: const Icon(Icons.check_circle_rounded, color: Colors.green, size: 40)),
            const SizedBox(height: 16),
            Text("Pengajuan Berhasil", style: GoogleFonts.poppins(fontSize: 18, fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            Text("Izin untuk siswa berhasil dikirim ke sistem sekolah.", textAlign: TextAlign.center, style: GoogleFonts.poppins(fontSize: 13, color: Colors.grey[600])),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text("Selesai", style: GoogleFonts.poppins(color: Colors.white, fontWeight: FontWeight.bold)),
              ),
            ),
